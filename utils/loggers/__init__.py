...
class Loggers():
    ...
    def __init__(self, save_dir=None, weights=None, opt=None, hyp=None, logger=None, include=LOGGERS):
        ...
        if not wandb:
            ...
            s = f"{prefix}run 'pip install wandb' to automatically track and visualize Artemis ✨ runs in Weights & Biases"
            self.logger.info(s)
        if not clearml:
            prefix = colorstr('ClearML: ')
            s = f"{prefix}run 'pip install clearml' to automatically track, visualize and remotely train Artemis ✨ in ClearML"
            self.logger.info(s)

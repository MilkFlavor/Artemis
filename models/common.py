# Artemis ✨ by MilkFlavor
# A Luna module, GPL-3.0 license
"""
Common modules
"""
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        pt = self._model_type(w)  # get backend
    ...
    def _model_type(p='path/to/model.pt'):
        # Returns model type based on file extension
...
class Detections:
    ...
    def save(self, labels=True, save_dir='input'):
        save_dir = increment_path(save_dir, exist_ok=save_dir != 'input', mkdir=True)  # increment save_dir
        self.display(save=True, labels=labels, save_dir=save_dir)  # save results

    def crop(self, save=True, save_dir='input'):
        save_dir = increment_path(save_dir, exist_ok=save_dir != 'input', mkdir=True) if save else None
